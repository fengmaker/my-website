...
!!! quote "**线性规划**（Linear Program）：是在线形约束下求解线性目标函数最优值的数学理论和方法。"
    ...
    - 对于<u>偏好学术、想要复习LP、适合有相关基础人群</u>，最佳的 LP 与 Simplex Method 笔记，请参考[离散优化：线性规划、单纯形法与进阶](../离散优化/Ch_03.md)。包含极点表示定理、 Farkas 引理、对偶理论、矩阵表示等；
...
> 
> 列生成算法的部分已迁移至[列生成算法](../求解算法/Chapter12.md)。
